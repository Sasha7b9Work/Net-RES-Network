...
DEF_GOVERNOR(_name, "Ïğåäåë ìèí", *page_self, EmptyVV, _min, _max, gset.measures.min[type])

#define DEF_GOVERNOR_MAX(_name, page_self, _min, _max, type)    \
DEF_GOVERNOR(_name, "Ïğåäåë ìàêñ", *page_self, EmptyVV, _min, _max, gset.measures.max[type])
