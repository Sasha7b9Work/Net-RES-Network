...
Pin         pinSCK_SPI1(GPIOA, GPIO_PIN_5, GPIO_PULLUP, GPIO_AF5_SPI1);
Pin         pinMOSI_SPI1(GPIOA, GPIO_PIN_7, GPIO_PULLUP, GPIO_AF5_SPI1);
Pin         pinMISO_SPI1(GPIOA, GPIO_PIN_6, GPIO_NOPULL, GPIO_AF5_SPI1);
...
PinOutputPP pinCS_HC12(GPIOA, GPIO_PIN_1, GPIO_NOPULL);
