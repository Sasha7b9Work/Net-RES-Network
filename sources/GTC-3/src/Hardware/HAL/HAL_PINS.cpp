...
PinOutputPP pinCS_ST(GPIOB, GPIO_PIN_12, GPIO_NOPULL);
Pin         pinSCL_SPI2(GPIOB, GPIO_PIN_13, GPIO_MODE_AF_PP, GPIO_PULLDOWN, GPIO_AF6_SPI2);
PinOutputPP pinDC_ST(GPIOB, GPIO_PIN_14, GPIO_NOPULL);
Pin         pinMOSI_SPI2(GPIOB, GPIO_PIN_15, GPIO_MODE_AF_PP, GPIO_PULLDOWN, GPIO_AF6_SPI2);
